...
However, this is done using positional encoding. Without positional encoding, the outputs are less than desirable as can be seen in the following figure.
...
The output images for the ship dataset are shown in the following figure.
